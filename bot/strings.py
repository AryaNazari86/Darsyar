...
channel = """🔔 لینک کانال اطلاع رسانی باتی درسیار در بله:‌ [لینک کانال](ble.ir/join/33meCDte4u)

🗣️ باتی ما را به دوستان خود معرفی کنید"""
...
help = "📋 لطفا برای دسترسی به قابلیت‌های باتی درسیار، منوی زیر را استفاده کنید."
...
🎓 درسیار | باتی هوشمند کمک درسی در بله
@darsyarbot"""
