...
📧 همچنین می‌توانید به آدرس darsyar.balebot@gmail.com ایمیل بزنید با به وبسایت darsyar.net مراجعه کنید."""
...
choose_class_note = """📚 برای دسترسی به دنیایی از جزوات درسی آماده‌ای؟

⏳ لطفا درس مورد نظرت رو انتخاب کن :"""

send_note = """➕ شما درخواست ارسال جزوه را کرده‌اید.

ℹ️ لطفا جزئیاتی مثل نام فصلی که جزوه به اون مربوط میشه رو روی نام فایلت بذار و بعد ارسال کن.

✅ جزوه‌ی ارسالی شما توسط تیم درسیار بررسی خواهد شد و برای دانش‌آموزان سراسر کشور ارسال خواهد شد.

🪪 نام شما برای تمام کسانی که جزوه‌تون رو مطالعه می‌کنند، نمایان خواهد شد.

📂 لطفا جزوه خود را تحت فرمت یک فایل برای درسیار ارسال کن"""

receive_note = """✅ درسیار جزوه شما را دریافت کرد!

👀 به زودی جزوه شما در دسترس دانش‌آموزان سر تا سر درسیار قرار خواهد گرفت.

❤️‍🔥 از کمک شما به دانش‌آموزان ممنونیم."""

tryagain_note = """🤔 متاسفانه نمی‌تونم جزوه‌ای توی پیامت پیدا کنم، مطمئن شو جزوه رو به صورت فایل می‌فرستی."""
note_caption = """📖 جزوه درس *{}*
✍️ ساخته شده توسط *{}*
👀 *{}* بازدید
⭐️ *{}* امتیاز
...
next_note = """⏭️ جزوه بعدی"""
reset_state = """🔙 بازگشت"""
show_menu_note = """📋 نمایش منو"""
upvote_note = """👍 لایک"""
downvote_note = """👎 دیسلایک"""
report_note = """🎤 گزارش جزوه"""
report_received = """✅ کاربر محترم، جزوه مد نظر گزارش شد و تیم درسیار به زودی آن را بررسی خواهند کرد.

😁 در این حین می‌توانید به ادامه استفادتون از درسیار بپردازید."""
vote_note_suc = """✅ رای شما با موفقیت ثبت شد."""
